...
var mimiDress = "yellow";
var bottomText = "white";
...
function draw() {
  ...
  strokeWeight(5);
  fill(mimiDress);
  ellipse(180,165,30,30);

  //right pigtail clip
  strokeWeight(5);
  fill(mimiDress);
  ellipse(365,165,30,30);
  ...
  textSize(14);
  fill(bottomText);
  text('Click your mouse to make the background disappear!', 100, 630);
  textSize(14);
  fill(bottomText);
  text('Press different keys to change her dress color! *Hint* Try pressing R, O, P and L!', 60, 655);
